# labeling_tools/manual_validation_labeler.py
...
# 실행 예시
# ------------------------
def manual_validation_labeler(config, manual_chk_list):
    ...
    project = manager.run_pipeline(is_pii=is_pii, candidate_list=manual_chk_list)
